...
use App\Orchid\Screens\NoteListScreen;
use App\Orchid\Screens\NotesListScreen;
...
Route::screen('clients', UserListScreen::class)
    ->name('platform.clients');

Route::screen('note', NotesListScreen::class)
    ->name('platform.notes');

Route::screen('/notes/{note}', NoteListScreen::class)
    ->name('platform.note.show');
